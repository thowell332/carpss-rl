...
# Create a factory function for gymnasium compatibility
# MultiAgentWrapper needs an instance, not a class
def make_tuple_multi_agent_intersection_env(**kwargs):
    """Factory function to create TupleMultiAgentIntersectionEnv."""
    env = MultiAgentIntersectionEnv(**kwargs)
    return MultiAgentWrapper(env)

# For backward compatibility, create a class that can be instantiated
class TupleMultiAgentIntersectionEnv:
    """Wrapper class for TupleMultiAgentIntersectionEnv."""
    def __init__(self, **kwargs):
        self.env = make_tuple_multi_agent_intersection_env(**kwargs)
...
register(
    ...
    entry_point='highway_env.envs.intersection_env:make_tuple_multi_agent_intersection_env',
)
