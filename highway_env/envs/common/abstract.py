...
class AbstractEnv(gym.Env):  # gym will be gymnasium if available
    ...
    metadata = {
        'render_modes': ['human', 'rgb_array'],  # For gymnasium
        'render.modes': ['human', 'rgb_array'],  # For backward compatibility with gym
    }
    ...
    def reset(self, seed=None, options=None) -> Tuple[Observation, dict]:
        ...
        :param seed: Optional seed for the random number generator (gymnasium API)
        :param options: Optional dictionary of additional options (gymnasium API)
        :return: Tuple of (observation, info) where info is an empty dict (gymnasium API)
        """
        ...
        info = {}  # gymnasium API requires info dict
        return obs, info
    ...
    def step(self, action: Action) -> Tuple[Observation, float, bool, bool, dict]:
        ...
        :return: a tuple (observation, reward, terminated, truncated, info) - gymnasium API
        """
